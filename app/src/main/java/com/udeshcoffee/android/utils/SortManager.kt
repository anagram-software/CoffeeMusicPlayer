...
object SortManager {
    ...
    object Key {
        val ARTISTS = "key_artists_sort_order"
        val ALBUMS = "key_albums_sort_order"
        val SONGS = "key_songs_sort_order"
        val ARTISTS_ASC = "key_artists_sort_order_asc"
        val ALBUMS_ASC = "key_albums_sort_order_asc"
        val SONGS_ASC = "key_songs_sort_order_asc"

        val ALBUM_SONGS= "key_album_songs_sort_order"
        val ALBUM_SONGS_ASC= "key_album_songs_sort_order_asc"

        val ARTIST_SONGS= "key_artist_songs_sort_order"
        val ARTIST_ALBUMS= "key_artist_albums_sort_order"
        val ARTIST_SONGS_ASC= "key_artist_songs_sort_order_asc"
        val ARTIST_ALBUMS_ASC= "key_artist_albums_sort_order_asc"

        val GENRE_SONGS= "key_genre_songs_sort_order"
        val GENRE_ALBUMS= "key_genre_albums_sort_order"
        val GENRE_SONGS_ASC= "key_genre_songs_sort_order_asc"
        val GENRE_ALBUMS_ASC= "key_genre_albums_sort_order_asc"

        val FAVORITES_SONGS= "key_fav_songs_sort_order"
        val FAVORITES_SONGS_ASC= "key_fav_songs_sort_order_asc"
    }
